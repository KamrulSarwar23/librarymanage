...
@section('section')
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
        ...
        <div class="intro-section" style="background-image: url('{{ asset('frontend/images/hero_2.jpg') }}');">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7 mx-auto text-center" data-aos="fade-up">
                        <div class="intro">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 ml-auto">
                    ...
                    <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi voluptate
                        asperiores rem quis consectetur cum quae, ratione voluptatem aliquam sit aspernatur.</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-1">
                        <div class="icon-wrapper bg-primary">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-circle-square"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-1">
                        <div class="icon-wrapper bg-primary">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-briefcase"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feature-1">
                        <div class="icon-wrapper bg-primary">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-calculator-fill"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
    ...
    <!-- // 05 - Block -->
    <div class="section-bg style-1" style="background-image: url('{{ asset('frontend/images/hero_1.jpg') }}')">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="news-entry-item">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('frontend/images/img_1.jpg') }}" alt="Image"
                                class="img-fluid">
                            <div class="date">
                                <span>3</span>
                                <span>July</span>
                ...
                <div class="col-lg-4">
                    <div class="news-entry-item">
                        <a href="#" class="thumbnail">
                            <img src="{{ asset('frontend/images/img_2.jpg') }}" alt="Image"
                                class="img-fluid">
                            <div class="date">
                                <span>3</span>
                                <span>July</span>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url('{{ asset('frontend/images/hero_2.jpg') }}')">
        <div class="container">
