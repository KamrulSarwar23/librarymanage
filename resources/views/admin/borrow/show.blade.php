                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <form id="borrowForm{{ $borrowBook->id }}"
                                                action="{{ route('book-borrow.updateOfflineInfo', $borrowBook->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                <select
                                                    class="mb-3 form_select {{ $borrowBook->status == 'receive' ? 'bg-info text-white' : '' }} {{ $borrowBook->status == 'reject' ? 'bg-danger text-white' : '' }} {{ $borrowBook->status == 'return' ? 'bg-success text-white' : '' }}"
                                            ...
                                            <tr>
                                                ...
                                                @if (!empty($borrowBook->due_at))
                                                    <td> {{ \Carbon\Carbon::parse($borrowBook->due_at)->format('F j, Y') }}
                                                    </td>
                                                @else
                                            ...
                                            <tr>
                                                <th>Late Fine</th>
                                                <td><span class="badge badge-danger">{{ $borrowBook->fine }} Taka</span>
                                                </td>
                                            </tr>
