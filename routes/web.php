...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Dashboard Routes
    Route::get('/dashboard', [DashboardController::class, 'adminDashboard'])->name('admin.dashboard')->middleware('permission:View Dashboard');
    ...
    // Category Routes
    Route::get('/active-category', [CategoryController::class, 'activeCategory'])->name('active.category')->middleware('permission:View Category');
    Route::get('/pending-category', [CategoryController::class, 'pendingCategory'])->name('pending.category')->middleware('permission:View Category');
    Route::put('/category/status', [CategoryController::class, 'changeStatus'])->name('category.status')->middleware('permission:View Category');
    Route::resource('category', CategoryController::class)->middleware('permission:View Category');

    // Publisher Routes
    Route::get('/active-publishers', [PublisherController::class, 'activePublisher'])->name('active.publisher')->middleware('permission:View Publisher');
    Route::get('/pending-publishers', [PublisherController::class, 'pendingPublisher'])->name('pending.publisher')->middleware('permission:View Publisher');
    Route::put('/publisher/status', [PublisherController::class, 'changeStatus'])->name('publisher.status')->middleware('permission:View Publisher');
    Route::resource('publisher', PublisherController::class)->middleware('permission:View Publisher');

    // Author Routes
    Route::get('/active-author', [AuthorController::class, 'activeAuthor'])->name('active.author')->middleware('permission:View Author');
    Route::get('/pending-author', [AuthorController::class, 'pendingAuthor'])->name('pending.author')->middleware('permission:View Author');
    Route::put('/author/status', [AuthorController::class, 'changeStatus'])->name('author.status')->middleware('permission:View Author');
    Route::resource('author', AuthorController::class)->middleware('permission:View Author');

    // Book Routes
    Route::get('/books/filterByType', [BookController::class, 'filterByType'])->name('books.filterByType')->middleware('permission:View Book');
    Route::get('/books/filterByDate', [BookController::class, 'filterByDate'])->name('books.filterByDate')->middleware('permission:View Book');
    Route::put('/book/type/change', [BookController::class, 'changeType'])->name('book.type.change')->middleware('permission:View Book');
    Route::put('/book/preview/change', [BookController::class, 'changePreview'])->name('book.preview.change')->middleware('permission:View Book');
    Route::get('/active-books', [BookController::class, 'activeBook'])->name('active.book')->middleware('permission:View Book');
    Route::get('/inactive-books', [BookController::class, 'inactiveBook'])->name('inactive.book')->middleware('permission:View Book');
    Route::get('/books/search-by-query', [BookController::class, 'bookSearch'])->name('books.search-by-query')->middleware('permission:View Book');
    Route::get('/books/by-category/{id}', [BookController::class, 'filterByCategory'])->name('admin.book-by-category')->middleware('permission:View Book');
    ...
    Route::get('/book/{bookId}/quantity', [QuantityController::class, 'index'])->name('quantity.index')->middleware('permission:View Book');
    Route::put('/book/{bookId}/quantity/status', [QuantityController::class, 'changeStatus'])->name('quantity.status')->middleware('permission:View Book');
    Route::post('/book/add_quantity', [QuantityController::class, 'store'])->name('quantity.store')->middleware('permission:Book');
    Route::delete('/book/quantity/{quantityId}', [QuantityController::class, 'destroy'])->name('quantity.delete')->middleware('permission:View Book');

    // Reader by books
    Route::get('/book/{bookId}/readers', [BookInventoryController::class, 'index'])->name('readers.index')->middleware('permission:View Book');
